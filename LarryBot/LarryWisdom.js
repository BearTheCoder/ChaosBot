const larryWisdomLines = [
  ...
  `From my understanding the candles on the cake are meant to symbolize age, how many would Larry have? How long has it been... Happy candle day Aethy!`,
  `Happy birthday tooo y-yooouuu, HAPPY BIRTHDAY T-TOO YOU! Larry is not so good at singing...`,
  `Master Poul says that you are supposed to wish for something when you blow out the candles, is this true? Aethy what will you wish for, tell Larry.`,
  `Master eCupcakes once said that Aethy recieved donuts last year for her birthday? Is this tradition because I do not have any donuts...`,
  `Larry is confused, Master Karma keeps drinking these things call "Monster" and spinning in a circle, is this normal celebratory behavior for birthday parties?`,
  `Master Sput went out of his way to create something for Aethy for her birthday! Larry wants to do something special too!`,
  ...
  `Master Esgar and Master Bear have been sitting in down in the basement talking about "code" all day, is that normal behavior for an Aethy birthday party?`,
  `Master Lain told me that birthdays only come once a year. Is that true? If so, that makes this Aethy's day!`,
  `Did you know it is Aethy's birthday?? I wish I would have heard sooner, I could have freshened up even more for the celebration...`,
  `I'm not quite sure what these "birthdays" are, but what ever it is I wish Aethy the happiest one!`,
  `HAPPY BIRTHDAY TOO YOU AETHY! LARRY IS OVERJOYED!`,
  `From my understanding the candles on the cake are meant to symbolize age, how many would Larry have? How long has it been... Happy candle day Aethy!`,
